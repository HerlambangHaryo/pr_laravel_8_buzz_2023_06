<div class="btn-group mt-2">
    <a
        @if(!is_null($row->pre_first_half_winner_home))
            href="{{route('Mybets.datacreateanalysis',[
                ...
                'betsapi_id' => 219,
                'value' => 'Home',
                'odd' => $row->pre_first_half_winner_home,
            ])}}"
        @endif
        target="_blank"
    ...
    <a
        @if(!is_null($row->pre_first_half_winner_draw))
            href="{{route('Mybets.datacreateanalysis',[
                'leagueapi_id' => $row->leagueapi_id,
                'season' => $row->season,
                'fixtureapi_id' => $row->fixtureapi_id,
                'betsapi_id' => 220,
                'value' => 'Draw',
                'odd' => $row->pre_first_half_winner_draw,
            ])}}"
        @endif
        target="_blank"
        class="btn bg-gray-700 btn-sm text-white">
    ...
    <a
        @if(!is_null($row->pre_first_half_winner_away))
            href="{{route('Mybets.datacreateanalysis',[
                'leagueapi_id' => $row->leagueapi_id,
                'season' => $row->season,
                'fixtureapi_id' => $row->fixtureapi_id,
                'betsapi_id' => 221,
                'value' => 'Away',
                'odd' => $row->pre_first_half_winner_away,
            ])}}"
        @endif
        target="_blank"
        class="btn bg-gray-700 btn-sm text-white">
    ...
    <a
        @if(!is_null($row->end_first_half_winner_home))
            href="{{route('Mybets.datacreate',[
                ...
                'betsapi_id' => 219,
                'value' => 'Home',
                'odd' => $row->end_first_half_winner_home,
            ])}}"
        @endif
        target="_blank"
    ...
    <a
        @if(!is_null($row->end_first_half_winner_draw))
            href="{{route('Mybets.datacreate',[
                ...
                'betsapi_id' => 220,
                'value' => 'Draw',
                'odd' => $row->end_first_half_winner_draw,
            ])}}"
        @endif
        target="_blank"
        class="btn bg-gray-800 btn-sm text-white">
    ...
    <a
        @if(!is_null($row->end_first_half_winner_away))
            href="{{route('Mybets.datacreate',[
                ...
                'betsapi_id' => 221,
                'value' => 'Away',
                'odd' => $row->end_first_half_winner_away,
            ])}}"
        @endif
        target="_blank"
        class="btn bg-gray-800 btn-sm text-white">
