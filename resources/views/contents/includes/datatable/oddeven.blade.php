        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-6 text-center">
                    {!! $row->preend->oddeven_odd_perc !!} -
                    {!! $row->preend->oddeven_even_perc !!}
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table id="datatableDefault" class="table  ">
                    <thead class=" ">
                        <tr>
                            ...
                            <x-html.th-content title="Pre Odd" />
                            <x-html.th-content title="Pre Even" />
                            <x-html.th-content title="End Odd" />
                            <x-html.th-content title="End Even" />
                        </tr>
                    </thead>
                    <tbody>
