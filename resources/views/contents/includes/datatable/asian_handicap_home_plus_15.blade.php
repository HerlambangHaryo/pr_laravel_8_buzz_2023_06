                ...
                <div class="col-6">
                    <div>
                        <div class="progress mt-3 mb-2" style="height: 15px;">
                            <div class="progress-bar" style="width: {{ $row_pattern->asian_handicap_home_plus_15_perc }}%">
                                {{ $row_pattern->asian_handicap_home_plus_15_data }} -
                                {{ number_format($row_pattern->asian_handicap_home_plus_15_perc, 2, ',', ' ') }}
                            </div>
                            <div class="progress-bar  bg-pink" style="width: {{ $row_pattern->asian_handicap_away_plus_15_perc }}%">
                                {{ $row_pattern->asian_handicap_away_plus_15_data }} -
                                {{ number_format($row_pattern->asian_handicap_away_plus_15_perc, 2, ',', ' ') }}
                            </div>
                        </div>
                    </div>
                </div>
