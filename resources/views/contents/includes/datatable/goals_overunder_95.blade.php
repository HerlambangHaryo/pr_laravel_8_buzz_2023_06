        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-6 text-center">
                    {!! $row->preend->goals_overunder_over_95_perc !!} -
                    {!! $row->preend->goals_overunder_under_95_perc !!}
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table id="datatableDefault" class="table  ">
                    <thead class=" ">
                        <tr>
                            ...
                            <x-html.th-content title="Pre Home +9.5" />
                            <x-html.th-content title="Pre Away -9.5" />
                            <x-html.th-content title="End Home +9.5" />
                            <x-html.th-content title="End Away -9.5" />
                        </tr>
                    </thead>
                    <tbody>
