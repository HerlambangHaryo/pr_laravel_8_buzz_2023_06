                ...
                <table id="datatableDefault" class="table  ">
                    <thead class=" ">
                        <tr>
                            ...
                            <x-html.th-content title="Pre o5" />
                            <x-html.th-content title="Pre u5" />

                            <x-html.th-content title="Pre o525" />
                            <x-html.th-content title="Pre u525" />

                            <x-html.th-content title="Pre o55" />
                            <x-html.th-content title="Pre u55" />

                            <x-html.th-content title="Pre o575" />
                            <x-html.th-content title="Pre u575" />

                            <x-html.th-content title="End o5" />
                            <x-html.th-content title="End u5" />

                            <x-html.th-content title="End o525" />
                            <x-html.th-content title="End u525" />

                            <x-html.th-content title="End o55" />
                            <x-html.th-content title="End u55" />

                            <x-html.th-content title="End o575" />
                            <x-html.th-content title="End u575" />
                        </tr>
                    </thead>
                    <tbody>
