                ...
                <div class="col-6">
                    <div>
                        <div class="progress mt-3 mb-2" style="height: 15px;">
                            <div class="progress-bar" style="width: {{ $row_pattern->asian_handicap_home_min_05_perc }}%">
                                {{ $row_pattern->asian_handicap_home_min_05_data }} -
                                {{ number_format($row_pattern->asian_handicap_home_min_05_perc, 2, ',', ' ') }}
                            </div>
                            <div class="progress-bar  bg-pink" style="width: {{ $row_pattern->asian_handicap_away_min_05_perc }}%">
                                {{ $row_pattern->asian_handicap_away_min_05_data }} -
                                {{ number_format($row_pattern->asian_handicap_away_min_05_perc, 2, ',', ' ') }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table id="datatableDefault" class="table  table-sm myTable ">
                    <thead class=" ">
                        <tr>
                            ...
                            <x-html.th-content title="H -0.5" />
                            <x-html.th-content title="A +0.5" />
                            <x-html.th-content title="H -0.5" />
                            <x-html.th-content title="A +0.5" />
                        </tr>
                    </thead>
