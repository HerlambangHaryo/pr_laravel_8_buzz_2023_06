            ...
            <div id="datatable" class="mt-3 mb-5">
                <div class="card">
                    <div class="card-header">
                        Data Pre-End #{{ $row->preend->id }} - Total:{{ $row->preend->total_fixtures }}

                        {{ $row_pattern->both_teams_score_yes_perc;}}
                    </div>
                    <div class="card-body">
                        <div>
                            <table id="datatableDefault" class="table  ">
                                ...
                                <tbody>
                                    ...
                                    @if($row_pattern->total_fixture < 3)
                                        <tr>
                                            <td colspan="9" class="text-center">

                                                <a
                                                    href="{{ route('Fixtures.preendcountry', [
                                                ...
                                                <a
                                                    href="{{ route('Fixtures.preendworld', [
                                                            'leagueapi_id'      => $row->leagueapi_id,
                                                            'season'            => $row->season,
                                                            'fixtureapi_id'     => $row->fixtureapi_id,
                                                        ])}}"
