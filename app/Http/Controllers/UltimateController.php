...
use App\Models\Football_ultimate_assessment;
...
class UltimateController extends Controller
{
    ...
    public function index()
    {
        ...
        // ----------------------------------------------------------- Action
            ...
            $data           = Football_ultimate_assessment::select(
                                    'leagueapi_id',
                                    'season',
                                ...
                                ->where('date', '<=', $date_end)
                                // ->whereIN('fixture_status',  ['Not Started', 'Not Started Goto'])
